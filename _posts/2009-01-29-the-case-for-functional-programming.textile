...
_Please consider the following as draft-quality stuff. I'm in the process of writing it and ramping up its average quality by a serious notch or two._
...
then we can safely assume some conclusions for these languages and those between them.

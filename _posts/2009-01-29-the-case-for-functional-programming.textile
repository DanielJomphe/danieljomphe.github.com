...
* He created the first compiler, along with the first high-level programming language: FORTRAN (1958).
...
Interestingly, this probably explains why Python hasn't superseded Java, although it was arguably much more mature at the eve of the new millenium than Java was. Well, languages don't sell only based on their worthiness.

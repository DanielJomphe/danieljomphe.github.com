...
* Types are *strongly* and *dynamically inferred*.
...
A few years after he wrote his paper, the technology needed for creating efficient compilers for functional languages started to become competitive. Since then, the gap has been closed. That is, of course, if you compare those functional and imperative languages whose compiler is designed for performance.
